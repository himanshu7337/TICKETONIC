...
public class BillPrintable implements Printable {
  ...
  {    
    ...
    private void initComponents() {
        ...
        jPanel3.add(CloseLbl);
        CloseLbl.setBounds(770, 0, 30, 30);
        ...
        jLabel7.setText("(If email id was valid and no network error occurred)");
        jPanel3.add(jLabel7);
        jLabel7.setBounds(150, 220, 570, 40);
        ...
        jLabel17.setText("An E-Ticket has been successfully sent to your registered email id.");
        jPanel3.add(jLabel17);
        jLabel17.setBounds(150, 190, 570, 40);
        ...
        jLabel10.setBounds(170, 290, 520, 30);
        ...
        jPanel3.add(jLabel8);
        jLabel8.setBounds(170, 260, 520, 40);

        Print.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/button_print_pressed.png"))); // NOI18N
        ...
        HomeBtn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bill_system/images/button_home_pressed.png"))); // NOI18N
        ...
        jPanel3.add(HomeBtn);
        HomeBtn.setBounds(440, 470, 100, 40);
    ...
    private void PrintMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_PrintMouseClicked
        ...
        try {
             pj.print();
           JOptionPane.showMessageDialog(this,"Ticket Saved / Printed Successfully !!!","Message", JOptionPane.INFORMATION_MESSAGE);
             //System.exit(0);
        }
